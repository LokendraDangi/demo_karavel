                                ...
                                <ul id="nav" class="hidden-xs">
                                    @foreach($data['menus'] as $menu)
                                        @if($menu->subcategories()->count() > 0)
                                            <li class="mega-menu"><a href="{{route('front.category',$menu->slug)}}" class="level-top"><span>{{$menu->name}}</span></a>
                                                <div class="level0-wrapper dropdown-6col">
                                                    <div class="container">
                                                        <div class="level0-wrapper2">
                                                            <h3><a href="{{route('front.category',$menu->slug)}}">{{$menu->name}}</a></h3>
                                                            <div class="nav-block nav-block-center">
                                                                <ul class="level0">
                                                                    @foreach($menu->subcategories as $subcategory)
                                                                        <li class="level1 nav-6-1 parent item"><a href=""><span>{{$subcategory->name}}</span></a>
                                                                            <ul class="level1">
                                                                                @foreach($subcategory->productlines()->limit(5)->get() as $product_line)
                                                                                    <li class="level2 nav-6-1-1"><a href=""><span>{{$product_line->name}}</span></a></li>
                                                                                @endforeach
                                                                            </ul>
                                                                        </li>@endforeach
                                                                </ul>
                        ...
                        <div class="mini-cart">
                            ...
                            <div class="fl-mini-cart-content">
                                <div class="block-subtitle">
                                    <div class="top-subtotal">{{\Gloudemans\Shoppingcart\Facades\Cart::count()}}items, <span class="price">Rs.{{\Gloudemans\Shoppingcart\Facades\Cart::total()}}</span> </div>
                                    <!--top-subtotal-->
                                    <!--pull-right-->
                                </div>
                                <!--block-subtitle-->
                                <ul class="mini-products-list" id="cart-sidebar">
                                    ...
                                    <li class="item first">
                                        <div class="item-inner"><a class="product-image" title="timi &amp; leslie Sophia Diaper Bag, Lemon Yellow/Shadow White" href="#l"><img alt="timi &amp; leslie Sophia Diaper Bag, Lemon Yellow/Shadow White" src="{{asset('frontend/products-images/p4.jpg')}}"></a>
                                            <div class="product-details">
                                                <div class="access"><a class="btn-remove1" title="Remove This Item" href="{{route('frontend.cart.delete',$cart->rowId)}}">Remove</a> </div>
                                                <!--access-->
                                ...
                                <div class="actions">
                                    <button class="btn-checkout" title="Checkout" type="button" onClick="window.location='{{route('frontend.cart.add')}}'"><span>Checkout</span></button>
                                    <button class="view-cart" title="Checkout" type="button" onClick="window.location='{{route('frontend.cart.index')}}'"><span>View Cart</span></button>
                                </div>
                                <!--actions-->
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4 col-xs-12 col-lg-4">
                        <div class="co-info">
                            <h4>Contact Us</h4>
                            <address>
                                <div><em class="icon-location-arrow"></em> <span>{{$profile->address}}</span></div>
                                <div> <em class="icon-mobile-phone"></em><span> {{$profile->phone}}</span></div>
                                <div> <em class="icon-envelope"></em><span>{{$profile->email}}</span></div>
                            </address>
                            <div class="social">

                                <ul class="link">
                                    <li class="fb pull-left"><a target="_blank" rel="nofollow" href="{{$profile->facebook_link}}" title="Facebook"></a></li>
                                    <li class="tw pull-left"><a target="_blank" rel="nofollow" href="{{$profile->twitter_link}}" title="Twitter"></a></li>
                                    <li class="googleplus pull-left"><a target="_blank" rel="nofollow" href="#" title="GooglePlus"></a></li>
                                    <li class="rss pull-left"><a target="_blank" rel="nofollow" href="#" title="RSS"></a></li>
                                    <li class="pintrest pull-left"><a target="_blank" rel="nofollow" href="#" title="PInterest"></a></li>
                                    <li class="linkedin pull-left"><a target="_blank" rel="nofollow" href="#" title="Linkedin"></a></li>
                                    <li class="youtube pull-left"><a target="_blank" rel="nofollow" href="{{$profile->youtube_link}}" title="Youtube"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
