...
@section('title','Cart Listing Page')
@section('content')
                                ...
                                <form action="#" method="post" id="shipping-zip-form">
                                    ...
                                    <ul class="form-list">
                                        <li>
                                            ...
                                            <div class="input-box">
                                                <select name="country_id" id="country" class="validate-select" title="Country"><option value="">Select Country</option><option value="AF">Afghanistan</option><option value="AX">Åland Islands</option><option value="AL">Albania</option><option value="DZ">Algeria</option><option value="AS">American Samoa</option></select>
                                            </div>
                                        </li>
                                        <li>
