    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Create ProductLine
            ...
            <div class="box-body">
               @include('layouts.includes.error')
                <form action="{{route('productline.store')}}" method="post">
                    ...
                    <div class="form-group">
                        <label for="subcategory_id">Select Sub Category Name</label>
                    ...
                    <input type="submit" name="submit" id="submit" class="btn btn-success" value="Save ProductLine">
