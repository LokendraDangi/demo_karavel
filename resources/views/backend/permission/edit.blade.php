    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Edit Premission
            ...
            <div class="box-body">
                ...
                <form action="{{route('permission.update',$data['permission']->id)}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="module_id" class="form-control" id="module_id" value="{{$data['permission']->module_id}}">
                        </input>
                    ...
                    <input type="submit" name="submit" id="submit" class="btn btn-success" value="Update Permission">
