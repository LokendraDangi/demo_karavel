                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="short_description" class="form-control" id="short_description">{{$data['product']->short_description}}</textarea>
                                        @include('layouts.includes.single_field_validation',['field'=>'short_description'])
                                    </div>
                                    <div class="form-group">
                                        <label for="description">Discription</label>
                                        <textarea name="description" class="form-control" id="description">{{$data['product']->description}}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if($data['product']->feature_key==1)
                                            ...
                                            <input type="radio" name="feature_key" value="0">DeActive
                                        @else
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if($data['product']->discount_key==1)
                                            <input type="radio" name="discount_key" value="1" checked>Active
                                            <input type="radio" name="discount_key" value="0">DeActive
                                        @else
                                            <input type="radio" name="discount_key" value="1">Active
                                            <input type="radio" name="discount_key" value="0" checked>DeActive
                                        @endif
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="tab-pane" id="tab_4">
                                    <div class="form-group">
                                        ...
                                        <select name="tag_id[]" class="form-control tag_id" name="tag_id" id="tag_id" multiple="multiple">
